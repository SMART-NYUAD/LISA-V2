...
### navigate_to
Navigate to a specific location (station, storage_area, or work_area).

### take_picture  
Take a photo with the robot's camera.

### analyze_image
Analyze the most recently taken image. Provide a prompt parameter to specify what to look for.
